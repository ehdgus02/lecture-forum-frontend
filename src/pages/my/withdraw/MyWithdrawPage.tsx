            ...
            <Card>
                <WarningBox>
                    ...
                    <WarningList>
                        ...
                        <li>
                            기존 게시글 및 댓글에 대한 수정이나 삭제를 더 이상 진행할 수 없게
                            됩니다.
                        </li>
                        <li>
...
// 백틱 안에 ${}를 쓴다는건, javascript를 실행해서 그 내용을 string 안에 넣는 방법 => 템플릿 리터럴
...
// pros.theme.colors.error 하나만 가지고도, 투명도를 조절해가면서 옅은 색상을 꺼낼 수 있다
