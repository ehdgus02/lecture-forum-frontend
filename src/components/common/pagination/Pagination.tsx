...
const PageNumButton = styled.button<{ $isActive: boolean }>`
    ...
    font-weight: 600;
    border: 1px solid
        ${props => (props.$isActive ? props.theme.color.primary : props.theme.color.divider)};
    background-color: ${props =>
        props.$isActive ? props.theme.color.primary : props.theme.color.background.paper};
    color: ${props => (props.$isActive ? "#FFFFFF" : props.theme.color.text.default)};
    border-radius: 6px;
    cursor: pointer;
    transition: all 0.2s;
